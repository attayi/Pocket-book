<template>
  <div class="user">
    <div class="head">
      <img class="avatar" src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fku.90sjimg.com%2Felement_origin_min_pic%2F01%2F05%2F70%2F4856f4cc994ca31.jpg&refer=http%3A%2F%2Fku.90sjimg.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1665476269&t=ec6afd8814a5cd2c28ac960039e72a8e" />
      <div class="info">
...
<style lang='less' scoped>
  ...
  .user {
    ...
    .head {
      display: flex;
      background: linear-gradient(315deg, pink 0%, pink 100%);
      padding: 12px;
      border-radius: 4px;
      margin-bottom: 12px;
      .avatar {
